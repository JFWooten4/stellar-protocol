...
### [24–30 May 2019](https://groups.google.com/g/stellar-dev/c/NtCwqWwAxRA): Initial Proposal and Draft Status

- David Mazières created CAP-21 on 24 May 2019.
- The proposal was merged as a Draft on May 30.
...
- David Mazières revived CAP-21 with a substantially revised proposal. He identified payment channels, relative timelocks, account recovery, and less brittle presigned transactions as motivating uses.
...
- Public specification review continued through Sep 17, documenting the remaining questions about account extensions, historical tests, queue conflicts, sequence constraints, and validation semantics.
...
- CAP-21 moved from `Draft` to `Awaiting Decision`. CAP-40, which supplied the complementary signed-payload signer for the payment-channel design, advanced alongside it.

### [4 Nov 2021](https://groups.google.com/g/stellar-dev/c/N8vzP2Mi89U/m/RrvypsfdAAAJ): Additional Use Case Documented
...
- `TimePoint` remained unsigned, and a zero `maxLedger` was defined as no upper ledger bound. `Duration` was corrected from a signed to an unsigned 64-bit type.
...
- The SDF announced that the Mainnet validator vote would occur on 8 Jun 2022 at 15:00 UTC.
